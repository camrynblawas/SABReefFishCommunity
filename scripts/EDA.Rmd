...
#abundance top 
ggplot(data = topdata, mapping = aes(x = year, y = abundance, color = accepted_name)) + geom_point() + geom_line() + ggtitle("Top 10 Abundance Trends Reef Survey") + my_theme() + labs(x = "Year", y = "Abundance", color = "Species Common Name")
ggsave(here("figures", "AbundanceTrendsTop10.png"), width = 6, height = 5, unit = "in")

#biomass top 10
ggplot(data = topdata, mapping = aes(x = year, y = biomass, color = accepted_name)) + geom_point() + geom_line() + ggtitle("Top 10 Biomass Trends Reef Survey") + my_theme() + labs(x = "Year", y = "Biomass", color = "Species Common Name") 
